...
const config = {
  SESSION_ID: process.env.SESSION_ID || "CRISS-AI~RxIH2baK#LlbAlJ2dHGrbmNT2tZqLA1WFSVpcbju74NQvXippGbo",
  ...
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/x7ygl0.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 ⟹P͙R͙A͜͡  𝗜M͙E⥃MUشAq!بKA",
  OWNER_NAME: process.env.OWNER_NAME || "⟹P͙R͙A͜͡  𝗜M͙E⥃MUشAq!بKA",
